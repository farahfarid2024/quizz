...
function handleOptionClick(selectedOption) {
  ...
  if (currentQuestionIndex < quizData.length - 1) {
    // Charger la réponse après un court délai
    setTimeout(() => {
      showAnswer();
      // Passer à la question suivante après un autre court délai
      setTimeout(() => {
...
// 2 - C/ Si ya plus de question, mettre une page résultat
// 2 - D/ Barre de progression
// 3 - Bonus: Minuteur
//      - Quand c'est 1 ou 0 secondes pas de "s"
// 3 - Bonus: Faire disparaitre le "bravo/sale" au bout d'une seconde
// 4 - Sauvegarder le score dans le local storage
